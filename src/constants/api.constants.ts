const currencyExchangeApiKey: string = '9b8a11bcf0858b1c4f7f925d';
...
export const getApplicationData = (id: string | number) => `/admin/application/${id}`;
export const submitScoringUrl = (id: string | number) => `/application/registration/${id}`;
export const storageKey: string = 'application_v1';
